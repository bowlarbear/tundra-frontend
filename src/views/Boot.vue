<!-- this page conditionally renders if the user does not currently have any passport-vault HW inserted (in which case they are prompted to install passport-vault software)
