<!-- User will be automatically brought to this screen by a text file present on HW 4 which informs tundra-vault to redirect the user to this page (state variable setup2)-->
<template>
