<!-- User will be automatically brought to this screen by a text file present on HW 6 which informs passport-vault to redirect the user to this page (state variable setup2)-->
